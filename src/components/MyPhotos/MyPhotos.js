...
const MyPhotos = () => {
  ...
  const handleRemovePhoto = (id) => {
    ...
    if (proceed) {
      fetch(`https://photo-album-server.up.railway.app/image/${id}`, {
        method: "DELETE",
      })
        .then((res) => res.json())
        .then((data) => {
  ...
  const handlePublicStatus = (id) => {
    ...
    const proceed = window.confirm(
      "Are you sure, you want to public this pic? If you do it, everyone will see your pic"
    );
  ...
  const handlePrivateStatus = (id) => {
    ...
    const proceed = window.confirm(
      "Are you sure, you want to private this pic? If you do it, anyone will not see your pic"
    );
